...
'8호선', '9호선',
# '분당선', '경의중앙선', '신분당선', '인천1호선', '인천2호선', '공항철도', '우이신설선',
# '경춘선', '수인선', '서해선', '용인경전철', '의정부경전철', '경강선'
]
toilet_list = {
    '1호선':[
'망월사', '도봉산', '도봉', '방학', '창동', '녹천', '월계', '석계(6호선)', '신이문',
'외대앞', '*동묘앞', '동대문(4호선)', '종로3가', '시청(2호선)', '*남영', '용산',
'노량진(9호선)', '신길', '영등포', '신도림', '구로', '구일', '간석',
'*석수(신창행승강장)', '관악', '*명학(광운대행승강장)', '*금정', '화서', '수원'
    ],
    '2호선':[
'시청', '을지로3가', '동대문역사문화공원', '왕십리', '건대입구', '종합운동장', '강남',
'사당(4호선)', '신림', '신대방', '구로디지털단지', '대림', '신도림(1호선)', '영등포구청',
'당산', '신답', '용두', '양천구청'
    ],
    '3호선':[
...
'가락시장(3호선)'
    ...
    '9호선':[
'김포공항', '당산', '국회의사당', '*여의도', '샛강', '노량진', '고속터미널',
'종합운동장(2호선)'
    ]
}
