#################### 데이터베이스 Databases ####################
# line5_west: 5호선 서쪽 지역의 역명 (방화~행당) (사용안함)
# line5_east: 5호선 동쪽 지역의 역명 (왕십리~상일동/마천) (사용안함)
# line4_south: 4호선 동대문역사문화공원역 기준 남부 지역의 역명 (숙대입구~충무로) (사용안함)
# line4_north: 4호선 동대문역사문화공원역 기준 북부 지역의 역명 (동대문~쌍문) (사용안함)
...
# DHCPServiceKakao: 카카오톡 플러스친구 5호선 - 4호선 환승방법 안내 메시지 (사용안함)
...
#
# 카카오 i 오픈빌더
# MidnightGuideResultKakao: 카카오i 오픈빌더 자정시간 귀가안내 결과 메시지
#
line5_west = [
...
'8호선', '9호선', '분당선', '경의중앙선', '신분당선', '공항철도', '인천1호선',
'인천2호선', '우이신설선', '경춘선', '서해선',
# '수인선', '용인경전철', '의정부경전철', '경강선'
]
toilet_list = {
    '1호선':[
'망월사', '도봉산', '도봉', '방학', '창동', '녹천', '월계', '석계(6호선)', '신이문',
'외대앞', '신설동', '*동묘앞', '동대문(4호선)', '종로3가', '시청(2호선)',
'서울역(공항철도)', '*남영', '용산', '노량진(9호선)', '대방', '신길', '영등포', '신도림',
'구로', '구일', '?부평(남부역방향)', '간석', '*석수(신창행승강장)', '관악',
'*명학(광운대행승강장)', '*금정', '?성균관대', '화서', '수원'
    ],
    '2호선':[
'시청', '을지로3가', '동대문역사문화공원', '왕십리', '건대입구', '종합운동장', '강남',
'사당(4호선)', '신림', '신대방', '구로디지털단지', '(대림)', '신도림(1호선)',
'영등포구청', '당산', '홍대입구(공항철도)', '신답', '용두', '신설동', '양천구청'
    ],
    '3호선':[
...
'남부터미널', '양재', '대치', '대청', '가락시장', '경찰병원', '오금'
    ...
    '4호선':[
'상계', '노원', '창동', '성신여대입구(오이도행승강장)', '동대문', '동대문역사문화공원',
'충무로', '명동', '회현', '서울역(공항철도)', '삼각지', '이촌', '동작', '이수', '사당',
'남태령', '과천', '정부과천청사', '*금정', '상록수', '한대앞', '중앙', '고잔',
'초지(서해선)'
    ],
    '5호선':[
'김포공항(9호선,공항철도)', '신정', '양평', '영등포구청(2호선)', '신길(1호선)',
'여의도(9호선)', '공덕(공항철도)', '종로3가', '동대문역사문화공원(4호선)',
'왕십리(2호선)', '올림픽공원(9호선)', '오금'
    ],
    '6호선':[
'연신내(3호선)', '디지털미디어시티', '월드컵경기장', '삼각지(4호선)', '한강진',
'약수(3호선)', '동묘앞(1호선)', '창신', '안암', '고려대', '석계'
    ],
    '7호선':[
'도봉산', '노원(4호선)', '상봉(경의중앙선,경춘선)', '*건대입구', '뚝섬유원지',
'고속터미널(9호선)', '이수', '남성', '대림(2호선)', '부천종합운동장', '부평구청'
    ],
    '8호선':[
'석촌(9호선)', '가락시장(3호선)'
    ],
    '9호선':[
'김포공항', '마곡나루(공항철도)', '당산', '국회의사당', '*여의도(개화방면)', '샛강',
'노량진', '동작', '고속터미널', '종합운동장(2호선)', '석촌', '올림픽공원'
    ],
    '분당선':[
'왕십리', '정자(신분당선)', '기흥', '수원'
    ],
...
'운서', '공항화물청사'
    ...
    '인천1호선':[
'계양(공항철도)', '부평구청(7호선)', '부평삼거리', '신연수', '원인재', '캠퍼스타운',
'테크노파크', '지식정보단지', '인천대입구', '센트럴파크', '국제업무지구'
    ],
    '인천2호선':[
'검암(공항철도)', '운연'
    ],
    '우이신설선':[
'신설동', '성신여대입구(4호선)', '*화계', '*북한산우이'
    ],
    '경춘선':[
'상봉',
    ],
...
MidnightGuideResultKakao = \
'''{0}에서 {1}까지 {2}에 귀가하는 경로를 요청하셨습니다.

귀가하실 때가 된다면, 그 때 다음 링크를 클릭해주시고 확인 부탁드립니다.
